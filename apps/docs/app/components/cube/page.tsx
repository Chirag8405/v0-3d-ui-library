      ...
      <main className="flex-1 pl-64">
        <div className="mx-auto max-w-3xl px-8 py-12">
          <article className="prose prose-neutral max-w-none">
            ...
            <ComponentPreview>
              <Scene backgroundColor="#fafafa" environment="studio" cameraPosition={[2.5, 2, 2.5]}>
    ...
    <Scene>
      ...
      />
            ...
            <ComponentPreview className="mb-4">
              <Scene backgroundColor="#fafafa" environment="studio" cameraPosition={[6, 3, 6]} controls={true}>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody className="text-muted-foreground">
                  ...
                  <tr className="border-b border-border">
                    <td className="py-3 px-2 font-mono text-foreground">color</td>
                    <td className="py-3 px-2 font-mono">string</td>
                    <td className="py-3 px-2">Variant color</td>
                  </tr>
                  <tr className="border-b border-border">
                    <td className="py-3 px-2 font-mono text-foreground">radius</td>
                    <td className="py-3 px-2 font-mono">number</td>
                    <td className="py-3 px-2">0.05</td>
                  </tr>
                </tbody>
              </table>
            </div>
